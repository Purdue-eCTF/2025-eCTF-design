...
class Encoder:
    def __init__(self, secrets: bytes):
        ...
        self.secrets = GlobalSecrets.from_json(secrets.decode("ascii"))

        # constructing signing key from private key is kind of long so do this ahead of time
        self.private_keys = {
            channel: channel_keys.signing_key()
            for channel, channel_keys in self.secrets.channels.items()
        }
    ...
    def encode(self, channel: int, frame: bytes, timestamp: int) -> bytes:
        ...
        channel_keys = self.secrets.channels[channel]
        ...
        return encrypt_payload(
            ...
            associated_data=struct.pack("<QB", timestamp, channel),
            symmetric_key=key,
